  ...
  return (
    <div className={'words-statistics'}>
      <div className={'statistics__inner'}>
        <h3 className={'statistics__title'}>Errors{' '}<span className='statistics__number_failure'>{failedWords.length}</span></h3>
        ...
        <h3 className={'statistics__title'}>Guessed{' '}<span className='statistics__number_success'>{learnedWords.length}</span></h3>
